...
class Institute(models.Model):
    ...
    phone = models.CharField("تلفن ثابت", max_length=20)
    mobile = models.CharField("موبایل", max_length=20, blank=True, default="")
    ...
    @staticmethod
    def _format_iran_phone(raw: str) -> str:
        """فرمت نمایشی شماره ایران: موبایل 0930-478-5743 یا ثابت 011-32350320."""
        if not raw:
            return ""
    ...
    def phone_formatted(self):
        """شماره تلفن ثابت با فرمت نمایشی (مثلاً 011-32350320)."""
        return self._format_iran_phone(self.phone)

    @property
    def mobile_formatted(self):
        """شماره موبایل با فرمت نمایشی (مثلاً 0930-478-5743)."""
        return self._format_iran_phone(self.mobile)

    @property
    def primary_call_number(self):
        """شماره اصلی برای تماس مستقیم (موبایل در اولویت)."""
        return self.mobile or self.phone

    @property
    def primary_call_formatted(self):
        return self.mobile_formatted or self.phone_formatted

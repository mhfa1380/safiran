...
STAGE_SCRIPTS = {
    CustomerCase.STAGE_ATTRACTION: [
        "از کجا با سفیران آشنا شدید؟",
        "کشور و مقطع مدنظرتان چیست؟",
        "الان برای شروع مسیر چقدر آماده‌اید؟ (زمان‌بندی)",
        "شماره واتساپ/تماس جایگزین دارید؟",
    ],
    CustomerCase.STAGE_INITIAL: [
        "آخرین مدرک و معدل تقریبی‌تان چیست؟",
        "مدرک زبان دارید یا در حال آماده‌اید؟ نمره؟",
        "بودجه تقریبی خانواده برای تحصیل چقدر است؟",
        "اولویت اصلی‌تان چیست: پذیرش، بورسیه، یا مهاجرت؟",
        "اگر جدی هستید، برای مشاوره تخصصی چه روزی مناسب است؟",
    ],
    CustomerCase.STAGE_FOLLOW_UP: [
        "از جلسه/تماس قبل چه تصمیمی گرفتید؟",
        "چه مانعی مانده؟ بودجه، زبان، خانواده، تردید؟",
        "مدارک ناقص کدام‌اند؟",
        "موعد بعدی واقع‌بینانه کی باشد؟",
    ],
    CustomerCase.STAGE_SPECIALIZED: [
        "کشور نهایی را قطعی کرده‌اید؟",
        "مدارک اولیه (پاسپورت، ریزنمرات، زبان) آماده‌اند؟",
        "خروجی این جلسه چه باشد تا ادامه دهیم؟",
        "چه کسی در تصمیم‌گیری خانواده دخیل است؟",
    ],
    CustomerCase.STAGE_FILE_OPEN: [
        "کدام آیتم چک‌لیست هنوز ناقص است؟",
        "زمان‌بندی ارسال اپلای را توافق کنیم؟",
        "مسئول ارسال مدارک خودتان هستید یا نماینده؟",
    ],
    CustomerCase.STAGE_ADMISSION: [
        "وضعیت اپلای/آفر الان چیست؟",
        "اگر آفر آمده، شرط‌ها و ددلاین چیست؟",
        "برای مرحله ویزا آماده‌اید؟",
    ],
    CustomerCase.STAGE_VISA: [
        "تمکن مالی آماده است؟",
        "وقت سفارت/انگشت‌نگاری گرفته شده؟",
        "نواقص مدارک ویزا چیست؟",
    ],
    CustomerCase.STAGE_DISPATCH: [
        "تاریخ پرواز قطعی شده؟",
        "اسکان/خوابگاه هماهنگ است؟",
        "مدارک سفر و هماهنگی تحویل کامل است؟",
    ],
}
